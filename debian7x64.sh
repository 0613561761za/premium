...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/zulizar/premium/master/squid/squid.conf"
...
cd
rm -rf .bashrc
wget https://raw.githubusercontent.com/zulizar/premium/master/text%20warna/.bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/zulizar/premium/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by YusufArdiansyah | telegram : e-Server | Pin BBM : yu-suf</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/zulizar/premium/master/conf/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf

# install openvpn
apt-get install openvpn -y
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/zulizar/premium/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/zulizar/premium/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.conf "https://raw.github.com/zulizar/premium/master/conf/iptables.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/zulizar/premium/master/conf/1194-client.conf"
...
#wget "https://raw.githubusercontent.com/zulizar/premium/master/dropbear201674/dropbear-2016.74.tar.bz2"
...
# bannerssh
wget "https://raw.githubusercontent.com/zulizar/premium/master/menu/bannersshlink.sh"
...
echo "20,40,56 * * * * root service dropbear restart" > /etc/cron.d/dropbear
echo "21,41,57 * * * * root service ssh restart" >> /etc/cron.d/dropbear
...
echo "1,5,10,15,20,25,30,40,45,50,55 * * * * root ./clearcache.sh" > /etc/cron.d/clearcache

# auto kill dropbear
#wget "https://raw.githubusercontent.com/zulizar/premium/master/menu/userlimit.sh"
#mv ./userlimit /usr/bin/userlimit.sh
#chmod +x /usr/bin/userlimit.sh
#echo " /etc/security/limits.conf" > /etc/security/limits.conf

# auto kill openssh
#wget "https://raw.githubusercontent.com/zulizar/premium/master/menu/userlimitssh.sh"
#mv ./userlimitssh.sh /usr/bin/userlimitssh.sh
#chmod +x /usr/bin/userlimitssh.sh

# cranjob
#sudo apt-get install cron
#wget https://raw.githubusercontent.com/zulizar/premium/master/clearcache/crontab
#mv crontab /etc/
#chmod 644 /etc/crontab

# tool 
cd
wget -O userlimit.sh "https://raw.githubusercontent.com/zulizar/premium/master/menu/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/zulizar/premium/master/menu/userexpired.sh"
#wget -O autokill.sh "https://raw.githubusercontent.com/zulizar/premium/master/menu/autokill.sh"
wget -O userlimitssh.sh "https://raw.githubusercontent.com/zulizar/premium/master/menu/userlimitssh.sh"
...
# clear cache
wget "https://raw.githubusercontent.com/zulizar/premium/master/clearcache/clearcache.sh"
#echo "@reboot root /root/clearcache.sh" > /etc/cron.d/clearcache
chmod 755 /root/clearcache.sh

# userlimit
#cd
#wget "https://raw.githubusercontent.com/zulizar/premium/master/conf/limits.conf"
...
wget -O speedtest.py "https://raw.githubusercontent.com/zulizar/premium/master/menu/speedtest.py"
...
wget https://raw.githubusercontent.com/zulizar/premium/master/ram/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
